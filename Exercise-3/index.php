                    ...
                    <form action="#" method="POST" class="">
                        <div class="mt-2 mb-2 ">
                            <div class="card-body shadow rounded my-3 p-3 w-80">
                                <select name="fname_keyword" id="" class="px-3 py-1 rounded" style="width: 120px;">
                                        ...
                                        <select name="lname_keyword" id="" class="px-3 py-1 rounded" style="width: 120px;">
                                        ...
                                        <select name="address_keyword" id="" class="px-3 py-1 rounded" style="width: 120px;">
                                        ...
                                        <select name="bdate_keyword" id="" class="px-3 py-1 rounded" style="width: 120px;">
                                            <option value=""></option>
                                            <?php
                                            if($res= $queryRes->num_rows > 0)
                                            {
                                        ...
                                        <select class="p-1 px-3 rounded" name="gender_keyword" style="width: 120px;">
                                        ...
                                        <select name="hr_keyword" id="" class="p-1 rounded" style="width: 120px;">
                                            <option value=""></option>
                                            <!-- <?php
                                                if($res= $queryRes->num_rows > 0)
                                                {
                                                    ...
                                                    {
                                                        ?>
                                                            <option value=""><?php echo $row["departmentName"]; ?></option>
                                                        <?php
                                                    }
                                                }
                                            ?> -->
                                ...
                                <button type="submit" name="search" class="btn btn-dark my-0 py-1"><i class="fa fa-search"></i> Search</button>
